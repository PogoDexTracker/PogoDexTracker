# POGO Dex Tracker — v1.4.3 Beta

Initial release: July 20, 2026
Last updated: July 20, 2026 (v1.4.3 — see changelog below)
...
### v1.4.3 Beta
- Reverted the 45° lightning bolt rotation from v1.4.2, back to the original upright orientation, per feedback that the angled version didn't look right.
